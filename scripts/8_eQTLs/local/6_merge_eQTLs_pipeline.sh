...
Rscript ./scripts/8_eQTLs/local/ComputeCorrelationToFitness.R $REPOSITORY_PATH HD_G1 Tcas3.30 PLASTICITY
Rscript ./scripts/8_eQTLs/local/ComputeCorrelationToFitness.R $REPOSITORY_PATH HD_G1 Tcas3.30 NOISE
...
Rscript ./scripts/8_eQTLs/local/MergeEQTLsDatasets.R $REPOSITORY_PATH HD_G1 Tcas3.30 _imputed PLASTICITY HD
Rscript ./scripts/8_eQTLs/local/MergeEQTLsDatasets.R $REPOSITORY_PATH HD_G1 Tcas3.30 _imputed NOISE HD
