...
python ./local/3_VariantsToTable.py -population CT_G1 -version Tcas3.30 -suffix imputed -annotation
...
for lin in ${LIN[@]}; do
  echo $lin
  python ./local/1_SelectPopulation.py -in-population ALL -in-suffix imputed -out-population CT_G1_$lin -out-suffix imputed -version Tcas3.30 -task VCF
  python ./local/3_VariantsToTable.py -population CT_G1_$lin -version Tcas3.30 -suffix imputed -annotation
...
python ./local/3_VariantsToTable.py -population HD_G1 -version Tcas3.30 -suffix imputed -annotation
...
for lin in ${LIN[@]}; do
  echo $lin
  python ./local/1_SelectPopulation.py -in-population ALL -in-suffix imputed -out-population HD_G1_$lin -out-suffix imputed -version Tcas3.30 -task VCF
  python ./local/3_VariantsToTable.py -population HD_G1_$lin -version Tcas3.30 -suffix imputed -annotation
...
for lin in ${LIN[@]}; do
  echo $lin
  python ./local/1_SelectPopulation.py -in-population ALL -in-suffix imputed -out-population CT_G21_$lin -out-suffix imputed -version Tcas3.30 -task VCF
  python ./local/3_VariantsToTable.py -population CT_G21_$lin -version Tcas3.30 -suffix imputed -annotation
...
for lin in ${LIN[@]}; do
  echo $lin
  python ./local/1_SelectPopulation.py -in-population ALL -in-suffix imputed -out-population HD_G21_$lin -out-suffix imputed -version Tcas3.30 -task VCF
  python ./local/3_VariantsToTable.py -population HD_G21_$lin -version Tcas3.30 -suffix imputed -annotation
